...
import (
	...
	cage_debug "github.com/codeactual/gomodfuzz/internal/cage/runtime/debug"
	"github.com/codeactual/gomodfuzz/internal/ldflags"
	tp_os "github.com/codeactual/gomodfuzz/internal/third_party/stackexchange/os"
)
...
func EnvPrefix(progName string) string {
	return strings.Replace(strings.ToUpper(progName), "-", "_", -1)
}
